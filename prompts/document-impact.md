...
保留問題編號、使用者回答的原意及方案的決定狀態。若現有文件互相矛盾，列出位置與需確認的問題，不自行替使用者選方案。完成後核對影響分析與程式文件是否一致，修正本次影響分析並說明依據。

本步只保存或修正 output/impact-analysis.md，保留其他文件、DD.json、程式與測試素材，不實作新功能或提交主機作業。
