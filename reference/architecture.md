...
CKP02是400字元定長檔更新程式（output/z-lab/CKP02.cbl:25）；OPEN I-O（73）、READ（75/88）、REWRITE（86）。第82–84行的IF句點先結束，REWRITE不在條件內。第14–16位資料為EOF時只略過轉換。第94–95行將舊第3–10位加兩空白移回前十位；R-ID群組為10+1=11，各欄位長度要一併計入。
