...
直接來源：bank-source/reading/CKP02.TXT:73的OPEN I-O與86的REWRITE，是正式dry-run設計需檢視的I/O點；82–84是條件，94–95是轉換。新增統計不得改動400字元記錄佈局，應採獨立計數或受控輸出。
...
可能影響：排程、下游取檔、重跑與備份策略。未提供實際Java、API、Database介面，不可宣稱存在或已修改。CIS14有IMS相依並不證明與CKP02串接。
