...
課程來源使用 IBM-937、CCKP 編譯使用 CODEPAGE(937),DBCS；JCL 與一般紀錄使用 IBM-1047。主機來源 <帳號>.TCBLAB.SRC937 是 PS、FB80，存放 CKP02，不能新增 member，也不能用新程式覆寫。若提案新增程式，來源位置與配置方式另列設計工作。
