...
後續課程加入檔案時，使用 output/z-lab 下的 .cbl、.cpy 與 .asm。CKP02 使用 output/z-lab/CKP02.cbl；CIS14 使用 output/z-lab/CIS14/CIS14.cbl 與同目錄的 .cpy。bank-source 的 TXT 保留作來源與完整性核對，不作為課程工作流程的附件。主機 JCL 內嵌的編譯副本則依 host-lab 指引準備。
