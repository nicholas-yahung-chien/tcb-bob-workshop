...
def build(out,jobname,volume=None,storage_class=None,source_dataset='YOURUSER.TCBLAB.COBOL'):
    ...
    manifest={'source':'z-lab/CKP02.cbl','source_dataset':source_dataset+'(CKP02)',
      ...
      'initial_jcl_transfer_encoding':'IBM-1047','connection_profile':'tcb-rse',
      'connection_encoding':'IBM-1371','source_change':'None; source members are provisioned before class from the supplied files, including Chinese comments.',
